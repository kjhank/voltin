export class DiscsIcon extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="67.708" height="72.672" viewBox="0 0 67.708 72.672">
  <defs>
    <linearGradient id="discs-a" x1="1.74" x2="-5.893" y1="-2.71" y2="2.864" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#214099" />
      <stop offset=".706" stop-color="#14265b" />
      <stop offset="1" stop-color="#11204d" />
    </linearGradient>
    <clipPath id="discs-b">
      <path fill="url(#discs-a)" d="M0 0h67.708v72.672H0z" data-name="Rectangle 704" />
    </clipPath>
  </defs>
  <g data-name="Group 14917">
    <g fill="url(#discs-a)" clip-path="url(#discs-b)" data-name="Group 14886">
